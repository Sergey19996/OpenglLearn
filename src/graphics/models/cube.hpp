...
public:
	...
	void init() {
        ...
        texture tex0("Assets/Rubbit.jpg", "texture0");
        tex0.load();
        texture tex1("Assets/Skull.png", "texture1");
        tex1.load();
    ...
    void render(Shader shader) {
       ...
       // model = glm::rotate(model, (float)glfwGetTime() * glm::radians(-55.0f), glm::vec3(0.5f));  //T. S. R. 
